...
Following Pauline Oliveros's distinction between hearing and listening, and between focal and global modes of attention (Deep Listening, 2005), these descriptors are read as traces of differentiated attentional regimes. Editorial reviews (Pitchfork) lean toward a focal attention that isolates sonic objects and formal detail, while experiential reviews (Amazon) lean toward a global attention centered on atmosphere and overall effect — showing that the same shared vocabulary supports distinct ways of orienting attention to sound.
