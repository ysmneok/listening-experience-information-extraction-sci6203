...
ALLOWED_SOURCE = "Amazon"
ALLOWED_GENRES = {"Classical"}

# citations lyrics in reviews
...
OUTPUT_SPANS = RESULTS_TABLES_DIR / "rule_spans_with_context_amazon_classical.csv"
OUTPUT_SUMMARY = RESULTS_TABLES_DIR / "rule_summary_amazon_classical.csv"
...
for doc_id, obj in enumerate(docs):
    ...
    if source != ALLOWED_SOURCE or genre not in ALLOWED_GENRES:
        continue
    # ----------------------------
